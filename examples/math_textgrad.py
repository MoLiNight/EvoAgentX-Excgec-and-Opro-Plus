...
def main(): 
    ...
    executor_config = AliyunLLMConfig(model="qwen-turbo", aliyun_api_key=my_api_key)
    executor_llm = AliyunLLM(config=executor_config)

    optimizer_config = AliyunLLMConfig(model="qwen-turbo", aliyun_api_key=my_api_key)
    optimizer_llm = AliyunLLM(config=optimizer_config)
