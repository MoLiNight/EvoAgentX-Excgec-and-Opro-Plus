...
import aflow.optimized.round_17.prompt as prompt_custom
...
class Workflow:
    ...
    def __init__(
        ...
        self.validator = operator.Custom(self.llm)  # New operator for validation
    ...
    async def __call__(self, problem: str):
        ...
        validation_result = await self.validator(
            ...
            instruction=r"""
                请验证以下 JSON 输出是否符合指定格式。如果不符合，请指出具体缺失或错误的字段，并提供修正建议。
