...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        if not solution['response'] or 'target' not in solution['response'] or 'edits' not in solution['response']:
            raise ValueError("Invalid output format from custom method.")
