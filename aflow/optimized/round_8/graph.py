...
import aflow.optimized.round_8.prompt as prompt_custom
...
class Workflow:
    ...
    def __init__(
        ...
        self.validator = operator.Validator(self.llm)  # New operator added for validation
    ...
    async def __call__(self, problem: str):
        ...
        validated_solution = await self.validator(input=solution['response'], instruction=r"""
            验证以下语法纠错结果是否符合格式要求，并返回验证通过的 JSON 数据。若不符合格式，请修正并返回正确的 JSON。
